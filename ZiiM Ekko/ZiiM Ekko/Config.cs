...
namespace ZiiM.Ekko
{
    ...
    {
        private const string MenuName = "ZiiM's Ekko";
        ...
        static Config()
        {
            ...
            Menu.AddGroupLabel("ZiiM's Ekko!");
        ...
        public static class Misc
        {
            ...
            public static class AutoStun
            {
                private static readonly CheckBox _useW;
                private static readonly Slider _MinEnemies;
                ...
                {
                    get { return _MinEnemies.CurrentValue; }
                }

                static AutoStun()
                {

                    Menu.AddGroupLabel("AutoStun(WIP)");
                    _useW = Menu.Add("AutoStunUseW", new CheckBox("AutoStun", false));

                    _MinEnemies = Menu.Add("Enemies", new Slider("Minimum people before auto stunning ({0}/{2})", 2, 1, 5));
